                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    ...
                                    <img src="{{asset('backend/assets/images/logo-light.png')}}" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                                ...
                                <strong>'Forgot your password? No problem.</strong> Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.
